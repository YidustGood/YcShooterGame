...
#include UE_INLINE_GENERATED_CPP_BY_NAME(YcExperienceDefinition)

#define LOCTEXT_NAMESPACE "YiChenGameplay"

UYcExperienceDefinition::UYcExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UYcExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UYcExperienceDefinition::UpdateAssetBundleData()
{
